<html>
	...
	<button class="button" ontouchstart="restart(this)" >Restart The Game</button>
	
	<div id="Mglass"><a href="checkDeer()" ><img class="displayed2" onclick="checkDeer()" src="images/Glass.png" ></a></div>
		...
		<div id="center">
			...
			<br></div>
			<br>
			<a href="IRScreen.php" class="button">Back</a>
			</div>
